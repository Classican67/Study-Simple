...
INSERT INTO "new_Note" ("createdAt", "folderId", "id", "ownerId", "searchText", "title", "updatedAt") SELECT "createdAt", "folderId", "id", "ownerId", "searchText", "title", "updatedAt" FROM "Note";
DROP TABLE "Note";
